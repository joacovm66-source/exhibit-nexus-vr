  ...
  },
  {
    ...
    exhibits: [
      ...
      },
      {
        ...
        nationality: "Chile",
        work: "Loco afán: Crónicas de sidario / Tengo miedo torero",
        description:
          "Pedro Segundo Mardones Lemebel fue un escritor y cronista chileno, conocido por sus aportes al movimiento LGBTQ+. Su obra aborda la marginalidad chilena utilizando referencias autobiográficas.",
        why: "Fue el primero en unir la identidad homosexual con la pobreza urbana y la política de barrio. Su lenguaje demuestra que la gran literatura también surge desde sectores marginados.",
        cover: PLACEHOLDER,
      },
      {
        id: "cabezon",
      ...
      },
      {
        ...
        nationality: "México",
        work: "Temporada de huracanes / Aquí no es Miami",
        description:
          "Una de las voces más brutales del México contemporáneo. Su literatura explora el feminicidio, el machismo extremo, la pobreza y cómo el narcotráfico y la violencia moldean la vida diaria de los pueblos y barrios populares de Veracruz. Usa un lenguaje lleno de groserías, furia y un ritmo de flujo de conciencia.",
        why: "Muestra el rostro más duro de México sin adornos. Su forma de escribir es rápida, intensa y directa, y sirve para denunciar cómo el machismo extremo y la falta de oportunidades destruyen la vida en los pueblos y barrios marginados.",
        cover: PLACEHOLDER,
      },
    ],
  },
